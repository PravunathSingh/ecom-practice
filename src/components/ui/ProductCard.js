...
const ProductCard = ({ img, title, price, description, rate }) => {
  return (
    <Link>
      <div className='mb-20 lg:mb-28'>
        <div className='overflow-hidden transition-all duration-200 border-2 border-gray-300 rounded-xl hover:shadow-xl'>
